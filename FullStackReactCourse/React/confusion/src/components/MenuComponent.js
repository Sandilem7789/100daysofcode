			...
			dishes: [
				...
				{  id: 1,
					...
					description:`Deep fried Zucchini coated with mildly spiced 
									Chickpea flour batter accompanied with a sweet-tangy 
									tamarind sauce`
				},
				{	id: 2,
					name:'Vadonut',
					...
					label:'New',
					price:'1.99',
					description:`A quintessential ConFusion experience, is it a vada 
									or is it a donut?`     
				},
				{	id: 3,
					...
					description:`A delectable, semi-sweet New York Style Cheese Cake, 
									with Graham cracker crust and spiced with Indian cardamoms`
				}
			]
		};
   }
